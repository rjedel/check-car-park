    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_park', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='car_park_opinions', to='car_park.carpark')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_opinions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='carpark',
            name='price_list',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='car_park.pricelist'),
        ),
        migrations.CreateModel(
            name='UserVotes',
            fields=[
                ...
                ('opinion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opinion_votes', to='car_park.opinion')),
